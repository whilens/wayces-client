...
const Account = () => {
  ...
  const handleSaveProfile = async (e) => {
    ...
    try {
      ...
      notification.error({
        message: 'Ошибка',
        description: err.response?.data?.error || 'Не удалось обновить профиль',
        placement: 'topRight',
      });
    } finally {
  ...
  const handleCancelOrder = async () => {
    ...
    try {
      ...
      notification.error({
        message: 'Ошибка',
        description: err.response?.data?.error || 'Не удалось подать заявку',
        placement: 'topRight',
      });
    } finally {
                      ...
                      <div key={fav.id} className="account__favorite-item">
                        ...
                        <div className="account__favorite-info">
                          ...
                          <p className="account__favorite-price">
                            {fav.product ? formatPrice(fav.product.basePrice) : ''}
                          </p>
                        </div>
