...
const Reviews = () => {
  ...
  const [rejectModal, setRejectModal] = useState<{ isOpen: boolean; reviewId: number | null }>({
    isOpen: false,
    reviewId: null,
  });
  ...
  const getStatusBadge = (status: string) => {
    ...
    const safeStatus = status as ReviewStatus;
    const { label, className } = statusMap[safeStatus] || statusMap.pending;
